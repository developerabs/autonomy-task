                    ...
                    <div class="card">
                        <div class="card-body p-5">
                            ...
                            <div class="mb-4">
                                ...
                                <input name="name" value="{{ old('name') }}" type="text" class="form-control" id="formGroupExampleInput" placeholder="Enter Product Name"/>
                            </div> 
                            <div class="mb-4">
                                <label for="form-product/name" class="form-label">Title</label>
                                <input name="title" value="{{ old('title') }}" type="text" class="form-control" id="formGroupExampleInput" placeholder="Enter Title"/>
                            </div>
                            <div class="mb-4">
                        ...
                        <div class="card-body p-5">
                            ...
                            <div class="row g-4">
                                <div class="col">
                                    ...
                                    <input name="unit_price" value="{{ old('unit_price') }}" type="number" class="form-control" id="formGroupExampleInput" placeholder="Enter Unit Price"/>
                                </div>
                                <div class="col">
                                    <label for="form-product/old-price" class="form-label">Purchase price</label>
                                    <input name="purchase_price" value="{{ old('purchase_price') }}" type="number" class="form-control" id="formGroupExampleInput" placeholder="Enter Purchase Price"/>
                                </div>
                            </div> 
                        </div>
                    </div>
                    <div class="card mt-5">
                        <div class="card-body p-5">
                            ...
                            <div>
                                ...
                                <input name="stock" value="{{ old('stock') }}" type="number" class="form-control" id="formGroupExampleInput" placeholder="Enter Stock Quentity"/>
                            </div>
                            <div class="mt-2">
                                <label for="form-product/quantity" class="form-label">Unit*</label>
                                <input name="unit" value="pcs" type="text" class="form-control" id="formGroupExampleInput" placeholder="Enter Unit Name"/>
                            </div>
                            <div class="mt-2">
                                <label for="form-product/quantity" class="form-label">Minimun Quentity*</label>
                                <input name="min_qty" value="1" type="number" class="form-control" id="formGroupExampleInput" placeholder="Enter Minimun Quentity"/>
                            </div>
                        </div>
                    </div>
                    <div class="card mt-5">
